...
if(isset($_POST['insert_product'])){
    ...
    if( $product_title=='' or $description=='' or $product_keywords=='' or $product_category=='' or$product_brands=='' or$product_image1=='' or$product_image2=='' or $product_image3=='' ){
        ...
        // insert Query
        $insert_products="insert into `products` (product_title, product_description, product_keywords, category_id, brand_id, product_image1, product_image2, product_image3, product_price,date_added, status) VALUES ('$product_title','$description','$product_keywords','$product_category', '1', '$product_image1','$product_image2','$product_image3','$product_price', NOW(),'$product_status')";
...
<head>
    ...
    <title>Insert Product | Dashboard</title>
    <!-- bootstrap css link  -->
...
<body class="bg-light">
    ...
    <select name="product_category" id="product_category" class="form-select">
        ...
        ?>
            ...
            <!-- submit -->
            <div class="form-outline mb4 w-50  m-auto ">
                <input type="submit" name="insert_product" class="btn btn-primary mb-3 px-3" >
        </form>
    </div>
