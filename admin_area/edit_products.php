...
if(isset($_GET['edit_products'])){
    ...
    // fetching data category name
    $select_category="SELECT * FROM `categories` WHERE `category_id`=$category_id";
    $result_category=mysqli_query($con,$select_category);
    $row_category=mysqli_fetch_assoc($result_category);
    $category_title=$row_category['category_title'];

    // fetching data brands name 
...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_desc" value="<?php echo $product_desc ?>" name="product_desc" class="form-control" required>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_price" value="<?php echo $product_price ?> DZ"name="product_price" class="form-control" required>
        </div>
        <div class="w-50 m-auto">
        <input type="submit" value="update Product" name="edit_product" class="btn btn-warning px-3 mb-3">
        </div>
    </form>
</div>
...
if(isset($_POST['edit_product'])){
    ...
    or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price=='' ){
        ...
        $update_product="UPDATE `products` SET `product_title`='$product_title', `category_id`='$product_category', `brand_id`='$product_brands', 
        `product_description`='$product_desc', `product_keywords`='$product_keywords', `product_image1`='$product_image1',
        `product_image2`='$product_image2', `product_image3`='$product_image3', `product_price`='$product_price', `date_added`=NOW() WHERE `product_id`='$edit_id'";
